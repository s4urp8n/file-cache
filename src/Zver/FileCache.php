    ...
    class FileCache
    {
        ...
        protected static function getCachePath($group = null, $key = null)
        {
            ...
            if (!is_null($key)) {
                ...
                $name .= static::splitToDirectories(mb_substr($fileHash, 0, 12, Common::getDefaultEncoding())) . mb_substr(
                        $fileHash, 12, null, Common::getDefaultEncoding()
                    ) . '.' . static::$extension;
            }
        ...
        public static function unregisterDirectory()
        {
